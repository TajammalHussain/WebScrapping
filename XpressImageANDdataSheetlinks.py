...
output_file = r'C:\Users\Tajammal\Desktop\MRF Brands upload\Xpress images\XpressImagesLink.xlsx'
sheet_name = 'Sheet1'
...
def find_product_info(product_code):
    ...
    return product_link, description_text, image_url

# Create new columns in the DataFrame for product links, descriptions, and image URLs
df['Product Link'] = ''
df['Description'] = ''
df['Image URL'] = ''
...
for index, row in df.iterrows():
    ...
    product_link, description, image_url = find_product_info(product_code)
...
print("Product links, descriptions, and image URLs have been successfully updated in the Excel file.")
